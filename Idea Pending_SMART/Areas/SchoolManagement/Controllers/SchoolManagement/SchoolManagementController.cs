...
public class SchoolManagementController : Controller
{
    ...
    public ViewResult Index()
    {
        ...
        ManageVM man = new ManageVM();

        man.School = _unitOfWork.School.GetAll();
        man.Semester = _unitOfWork.Semester.GetAll();
        man.Course = _unitOfWork.Course.GetAll();
    ...
    [BindProperty]
    public ManageVM ManageObj { get; set; }
